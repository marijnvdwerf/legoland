...
void RemoveIconGroup(unsigned int group);
void FUN_0046d590(unsigned int val);
void FUN_0046d680(struct IconNode *node, struct Sprite *sprite);
struct SpriteIcon *LoadSpriteIcon(const char *filename, unsigned int param_2, unsigned int param_3, unsigned int param_4, unsigned int param_5);
